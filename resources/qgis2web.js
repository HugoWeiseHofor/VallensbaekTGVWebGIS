...
lyr_Vallensbk.setZIndex(9999);
lyr_Vallensbk.setVisible(true);
lyr_Vallensbk.set('title', '');
map.addLayer(lyr_Vallensbk);

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit(
    [1373596.397379, 7480810.220985, 1385794.096155, 7490390.254763],
